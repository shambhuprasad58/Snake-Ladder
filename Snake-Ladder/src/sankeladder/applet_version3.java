...
public class applet_version3
{
 ...
 //   public static void main(String argsp[]) throws IOException
    {
        dicei = new BufferedImage[6];
        String image_read=null;
        for(int a=0;a<6;a++)
        {
            image_read="dice"+(a+1)+".png";
            dicei[a]=ImageIO.read(new File(image_read));
        }
        ...
        ob1.im1 = ImageIO.read(new File("red_coin.png"));
       ...
       // f.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        j1 = new JPanel();
        int bound = (12-size)*25;
        System.out.println("BOUND"+bound);
        j1.setBounds(50,(12-size)*25,(50*size)+60,(50*size)+60);
        j1.setLayout(null);
        j1.setLayout(new java.awt.FlowLayout());
        j1.setBounds(((12-size)*25)+50,(12-size)*25,(50*size)+60,(50*size)+60);
        f.add(j1);
        c1 = new Canvas1();
        c1.size=size;
        ...
        bt.setDisabledIcon(new javax.swing.ImageIcon("dice_01.png")); // NOI18N

        org.jdesktop.beansbinding.Binding binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, bt, org.jdesktop.beansbinding.ELProperty.create("${disabledIcon}"), bt, org.jdesktop.beansbinding.BeanProperty.create("icon"));
        bindingGroup.addBinding(binding);
        bt.setText("ROLL");
        bt.setBounds(750, 300, 125, 60);
        bt.setVisible(true);
        bindingGroup.bind();
        final JTextField Message_Box = new JTextField();
        Message_Box.setBounds(750 ,375 , 400, 25);
        ...
        public void mouseClicked(MouseEvent e)
        {
                ...
                try {
                    ...
                    while(a<250)
                    {
                        f.getGraphics().drawImage(dicei[(a%6)], 750, 450, im);
                        a++;
                    }
    ...
    f.addMouseMotionListener(new java.awt.event.MouseMotionAdapter() {
            ...
            public void mouseMoved(java.awt.event.MouseEvent evt) {
                try {
                    ...
                    Logger.getLogger(applet_version3.class.getName()).log(Level.SEVERE, null, ex);
                }
            }

            private void formMouseMoved(MouseEvent evt) throws IOException {
                ImageObserver im=null;
                if(c1.snake_image<1)
                    {
                        snake_ladder_image(c1, snakes, ladders, size);
                        if(randomInt>0)
                            f.getGraphics().drawImage(dicei[randomInt-1], 750, 450, im);
                        c1.snake_image++;
                    }
          ...
          /*  public void formMouseMoved(WindowEvent evt) throws IOException {
                snake_ladder_image(c1, snakes, ladders, size);
                //throw new UnsupportedOperationException("Not yet implemented");
            }
        });*/
    ...
    public int fun(Canvas1 c1,int size,Objects ob1,int[] snakes, int[] ladders, JTextField Message_Box,int[] score)
    {
        ...
        f.getGraphics().drawImage(dicei[randomInt-1], 750, 450, io);
        System.out.println("RandomInt" + randomInt);
        if(pos+randomInt < ((size*size)+1))
        {
            if(randomInt==6 && pos == ((size*size)+1))
            {
           ...
           // c1.getGraphics().fillOval( 12 + (50 * ob1.start_red_x),  13 + (ob1.start_red_y * 50), 25, 25);
            ...
            {
                got_ladder=1;
                Message_Box.setText("You Got "+randomInt+" Ladder at "+pos+"Got You!!! Roll Again");
                prev_x = ob1.start_red_x;
                prev_y = ob1.start_red_y;
                pos = ob1.pos;
